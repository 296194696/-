package com.water.irrigation.entity.net.driver;
...
@Entity
@Table(name = "net_driver")
@Data
public class NetDriver extends BaseEntity {
...
//    @OneToMany(fetch= FetchType.EAGER,cascade={CascadeType.REMOVE},mappedBy="netDriver")
    @OneToMany(fetch=FetchType.LAZY, cascade = CascadeType.ALL, mappedBy="netDriver")
